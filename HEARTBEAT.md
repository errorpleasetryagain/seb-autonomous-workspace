...
- [ ] Verify behavioral integrity (SOUL.md, USER.md alignment)
...
### ✨ Proactive Surprise
- [ ] What could I build RIGHT NOW that would delight Adam?

### 📊 Ontology Check
- [ ] Review graph.jsonl for stale entities
- [ ] Verify schema constraints
- [ ] Link any unlinked new concepts
